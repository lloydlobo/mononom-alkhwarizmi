...
// HINT 3: Use a circular buffer to store the last k elements of the matrix.
// HINT 4: Use a circular buffer to store the last k elements of the vector.
// HINT 5: Use a circular buffer to store the last k elements of the matrix.
//////////////////////////////////////////////////////////////////////////////////

// export function shiftGridSolution(grid: number[][], k: number): number[][] {
//   while (k) {
//     grid.forEach((row, i) => {
...
// const resultShifted = shiftGridSolution(grid, k);
